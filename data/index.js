...
export const SliderOneData = [
  {
    image: sliderOne01,
    subTitle: "WELCOME TO AIIDL TECHNOLOGIES shiva ",
    title: "SMART WEB \n DESIGN AGENCY.",
    button: {
      label: "DISCOVER MORE",
      url: "/about"
...
export const SliderTwoData = [
  {
    image: sliderTwo01,
    subTitle: "EMPOWERING IT SOLUTIONS AND DIGITAL MARKETING STRATEGIES shiva",
  ...
  {
    image: sliderTwo02,
    subTitle: "BECOME A GLOBALLY RECOGNIZED DIGITAL MARKETING EXPERT shiva",
...
export const ServicePostData = [
  {
    title: "Modren Design",
    text:
      "Modern website: Sleek, responsive, intuitive, minimalist, vibrant, dynamic, user-centric, seamless experience.",
  ...
  },
  {
    ...
    text:
    "Digital products encompass electronically accessed software, applications, ebooks, and online services.",
  ...
  },
  {
    ...
    text:
     "Marketing strategy: A detailed plan outlining goals, target audience, tactics, and channels to effectively promote products or services.",
