...
export const ServicePostData = [
  {
    title: "Modren Design",
    text: "Modern design website: Sleek, responsive layout, intuitive navigation, minimalist aesthetic, vibrant visuals, dynamic content, user-centric interface, seamless experience",
    iconName: "mei-settings",
    url: "/service-details"
  },
  {
    title: "Digital products",
    text:"Digital product: Intangible offering accessed electronically, including software, apps, ebooks, and online services for various purposes or functions",
  ...
  },
  {
    ...
    text:
      "A comprehensive plan outlining goals, target audience, tactics, and channels to promote products or services effectively.",
